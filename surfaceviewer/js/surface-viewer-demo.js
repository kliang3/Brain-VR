  ...
  window.viewer = BrainBrowser.SurfaceViewer.start("brainbrowser", function(viewer) {
    ...
    $("#mniobj").change(function() {
     ...
     $("#freesurferasc").change(function() {
      ...
      console.log(format);
      showLoading();
      viewer.loadModelFromFile(document.getElementById("freesurferasc"), {
        format: format,
        complete: hideLoading
      });
  ...
  //load per vertex data 
   /* $("#data-submit").click(function() {
    ...
    $("#textdata").change(function() {
      var format = "text"; 
      console.log(format);
      viewer.loadIntensityDataFromFile(document.getElementById("textdata"), {
        format: format,
        blend: true
      });
    });

      $("#freesurferbindata").change(function() {
      var format = "freesurferbin"; 
      console.log(format);
      viewer.loadIntensityDataFromFile(document.getElementById("freesurferbindata"), {
        format: format,
        blend: true
      });
    });

     $("#freesurferascdata").change(function() {
      var format = "freesurferasc"; 
      console.log(format);
      viewer.loadIntensityDataFromFile(document.getElementById("freesurferascdata"), {
        format: format,
        blend: true
      });
    }); 
