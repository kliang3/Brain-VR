//creates a new property in the BrainBrowser object 
//config is the BrainBrowser.createTreeStore() has config.set, config.get methods
//BrainBrowser.set() --> sets the value at a specified place, uses CreateTreeStore.set()
//BrainBrowser.set() --> gets the value at a specified place, uses CreateTreeStore.get()
(function() {
  "use strict";
  ...
  BrainBrowser.config = {
    ...
    */
    get: function(config_string) {
      ...
      return config.get.apply(config, config_params); //returns the value from the CreateTreeStore.get
      //config is the name of the function createTreeStore()
    }
  };
